...
class YQLCollector
  ...
  def where(where_clause=nil)
    ...
    yql_query = "https://query.yahooapis.com/v1/public/yql?q=#{self.to_yql}&format=json&diagnostics=true&env=store%3A%2F%2Fdatatables.org%2Falltableswithkeys"
